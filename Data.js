            ...
            <div className="col-2 position-fixed float-left" style={{height: "100%", backgroundColor: "#9A86A4"}}>
                <aside className="p-3 mb-2 text-white" style={{width: "100%"}}>
                    ...
                    <a className="navbar-brand" href="#">
                        ...
                        <Link to ="/Dasboard" className="App-link" style={{textDecoration: "none", color: "white"}}>Dasboard</Link> {" "}
                    </a><br /><br />
                    ...
                    <a className="navbar-brand" href="#">
                        ...
                        <Link to ="/Loginuser" className="App-link" style={{textDecoration: "none", color: "white"}}>Logout</Link> {" "}
                    </a><br/><br/>
                </aside>
                                  ...
                                  <tr>
                                    ...
                                    <div className="row">
                                        <div className="col d-flex justify-content-center p-0">
                                            <a href="" className="btn btn-sm btn" data-bs-toggle="modal" data-bs-target="#modalEdit" style={{backgroundColor: "#6495ED", color: "white"}}>Edit</a>
                                        </div>
                                        <div className="col d-flex justify-content-center p-0">
