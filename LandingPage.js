...
export default function LandingPage() {
    ...
    <>
        <nav className="navbar navbar-light bg-light">
            ...
            <Link to ="/Loginuser" className="App-link btn btn-outline-dark" style={{marginTop: "20px", marginBottom: "5px"}}>Login</Link> {" "}
            <Link to ="/Signup" className="App-link btn btn-outline-dark" style={{marginTop: "20px", marginBottom: "5px"}}>Signup</Link> {" "}
            </form>
            </div>
        </nav>
                ...
                <h2><p className="card-text" style={{color: "black"}}><br />Tautan Pendek, Hasil Memuaskan</p></h2>
                    <h4><small className="text-muted" /> <br /><br />Penyingkat URL yang dibuat untuk membantu anda mengembangkan dan melindungi merk anda</h4>
                        <div className="p-3 mb-2 bg-denger text-black">
                            ...
                            <br/><br/><br/>
                            <Link to ="/Signup" className="App-link" style={{textDecoration: "none", color: "white"}}>Mulai Gratis</Link> {" "}
                        </div>
            </div>
        </div> 
